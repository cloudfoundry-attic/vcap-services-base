...
class VCAP::Services::Base::Provisioner < VCAP::Services::Base::Base
  ...
  def initialize(options)
    ...
    @version_alias = options[:version_alias]
  ...
  def provision_service(request, prov_handle=nil, &blk)
    ...
    #TODO: Remove this check, request.version should always be non-null once we make version mandatory
    version = request.version unless request.version == nil
