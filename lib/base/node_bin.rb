...
class VCAP::Services::Base::NodeBin
  ...
  def start
    ...
    options = {
      ...
      :service_bin_dir => parse_property(config, "service_bin_dir", String, :optional => true),
      :service_script_dir => parse_property(config, "service_script_dir", String, :optional => true),
      :service_conf_dir => parse_property(config, "service_conf_dir", String, :optional => true),
    ...
    if use_warden
      ...
      options[:service_bin_dir] = parse_property(warden_config, "service_bin_dir", String, :optional => true)
      options[:service_script_dir] = parse_property(warden_config, "service_script_dir", String, :optional => true)
      options[:service_conf_dir] = parse_property(warden_config, "service_conf_dir", String, :optional => true)
